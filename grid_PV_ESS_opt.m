...
e_bat_max=3; % bireysel batarya boyutland?rmas? yap?l?rken batarya kapasitesi evsel tüketimin (kwh) 2 gün ?ebekeden ba??ms?z kar??lanabilecek kadar kapasite dikkate alinarak olusturulmustur
% sebeke=sum(p_other);
